...
#### REASON: In search of curiosity and with the intent to understand the scope of the data, this puts a path forward to better improve management and intelligence through auditing and inspection that will help shape my goals in the Inspector General field.
